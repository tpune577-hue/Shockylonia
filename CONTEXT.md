# CONTEXT.md — Shocky Topia Domain Glossary
...
## Character
ตัวละครหนึ่งตัวในโลก Shocky Topia มี **Race**, **Stats**, **Survival** state และ **Memory** ของตัวเอง
...
## The Blessing (พรแห่ง Shocky Topia)
พรที่ผู้คนทุกคนในแผ่นดิน Shocky Topia ได้รับ — ทำให้มีอายุยืนยาวและไม่ตายตามอายุขัยตามธรรมชาติ
