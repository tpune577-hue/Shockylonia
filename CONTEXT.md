...
## Instinct Mode
สถานะที่ Character รันด้วย **rule-based fallback** แทน Agent เมื่อ token หมด / API ล่ม
Character ไม่ตาย แต่ทำเฉพาะ routine พื้นฐาน (กิน-นอน-ทำงานเดิม-หนีเมื่อถูกตี) — ดู ADR-0004
